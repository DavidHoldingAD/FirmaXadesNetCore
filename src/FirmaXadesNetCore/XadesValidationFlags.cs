...
/// </summary>
[Flags]
public enum XadesValidationFlags : ulong
{
	/// <summary>
	...
	/// <summary>
	/// Check to see if first XMLDSIG certificate has same hash value as first XAdES SignatureCertificate.
	/// </summary>
	...
	/// <summary>
	/// Check that QualifyingProperties occur in one Object, check that there
	/// is only one QualifyingProperties and that signed properties occur in one QualifyingProperties element.
	/// </summary>
